...
GLOBAL_R0_RELEASE_SHA="0291559185f9ebb1fe6c215ec74a94f97de747c4cac47953bc3e4317be53d6e3"
REGIONAL_PRE_TRAILING_SLASH_RELEASE_SHA="804857e0867dfff19a5369eebf06cfe1d7865eff6d28e78309921d3cfd38ab52"
...
is_reviewed_predecessor_sha() {
	case "$1" in
		"$REDIRECT_SHA" | "$V1_SHA" | "$V2_SHA" | "$LAST_RELEASE_SHA" | "$PRE_R0_RELEASE_SHA" | "$GLOBAL_R0_RELEASE_SHA" | "$REGIONAL_PRE_TRAILING_SLASH_RELEASE_SHA" | "$REGIONAL_RELEASE_SHA") return 0 ;;
		*) return 1 ;;
	esac
}
