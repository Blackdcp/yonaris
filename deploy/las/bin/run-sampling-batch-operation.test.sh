...
{"schemaVersion":1,"operation":"run-sampling-batch","requestId":"stepfun-cn-doubao-6x-20260813","manifestPath":"apps/worker/src/sampling-batch-requests/stepfun-cn-doubao-6x-20260813.json"}
EOF
...
set -Eeuo pipefail
joined=" $* "
expected=" --profile operations run --rm --no-deps -T account-ops node ./node_modules/tsx/dist/cli.mjs ./src/run-sampling-batch.ts --request-file ./src/sampling-batch-requests/stepfun-cn-doubao-6x-20260813.json "
...
if [[ "${MOCK_BATCH_EXISTS:-false}" == "true" ]]; then
	printf '%s\n' '{"ok":true,"requestId":"stepfun-cn-doubao-6x-20260813","idempotencyKey":"sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-13","action":"existing_noop","batchId":"batch-1","brandId":"brand-1","brandName":"StepFun","scopeId":"scope-1","scopeKey":"cn-zh-scored","status":"in_progress","automationStatus":"running","plannedTaskCount":18,"succeededTaskCount":0,"failedTaskCount":0,"measurementWindow":{"startsAt":"2026-08-13T00:00:00.000Z","endsAt":"2026-08-20T15:59:59.000Z"},"timezone":"Asia/Shanghai"}'
	exit 0
fi
case "$mode" in
	status-only) printf '%s\n' '{"ok":true,"requestId":"stepfun-cn-doubao-6x-20260813","idempotencyKey":"sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-13","action":"existing_noop","batchId":"batch-1","brandId":"brand-1","brandName":"StepFun","scopeId":"scope-1","scopeKey":"cn-zh-scored","status":"in_progress","automationStatus":"running","plannedTaskCount":18,"succeededTaskCount":0,"failedTaskCount":0,"measurementWindow":{"startsAt":"2026-08-13T00:00:00.000Z","endsAt":"2026-08-20T15:59:59.000Z"},"timezone":"Asia/Shanghai"}' ;;
	dry-run) printf '%s\n' '{"ok":true,"requestId":"stepfun-cn-doubao-6x-20260813","idempotencyKey":"sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-13","action":"would_create_freeze_start","batchId":null,"brandId":"brand-1","brandName":"StepFun","scopeId":"scope-1","scopeKey":"cn-zh-scored","status":"absent","automationStatus":null,"plannedTaskCount":18,"succeededTaskCount":0,"failedTaskCount":0,"measurementWindow":{"startsAt":"2026-08-13T00:00:00.000Z","endsAt":"2026-08-20T15:59:59.000Z"},"timezone":"Asia/Shanghai"}' ;;
	apply) printf '%s\n' '{"ok":true,"requestId":"stepfun-cn-doubao-6x-20260813","idempotencyKey":"sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-13","action":"created_frozen_started","batchId":"batch-1","brandId":"brand-1","brandName":"StepFun","scopeId":"scope-1","scopeKey":"cn-zh-scored","status":"in_progress","automationStatus":"running","plannedTaskCount":18,"succeededTaskCount":0,"failedTaskCount":0,"measurementWindow":{"startsAt":"2026-08-13T00:00:00.000Z","endsAt":"2026-08-20T15:59:59.000Z"},"timezone":"Asia/Shanghai"}' ;;
esac
EOF
