...
case "$path" in
	...
	*/.las-stable-bundle-active-v1.active.new | */.las-stable-bundle-pending-v1.new)
		printf '0:0:600\n' ;;
	*/las-active-portal-release-v1 | */las-active-marketing-release-v1 | \
...
STUB
	...
	done
	{
		...
		printf '%s\n' 'allow sha-1111111111111111111111111111111111111111 deploy web-sha256 sha256:1111111111111111111111111111111111111111111111111111111111111111 worker-sha256 sha256:2222222222222222222222222222222222222222222222222222222222222222 migrate-sha256 sha256:3333333333333333333333333333333333333333333333333333333333333333 postgres-sha256 sha256:4444444444444444444444444444444444444444444444444444444444444444 www-sha256 sha256:5555555555555555555555555555555555555555555555555555555555555555'
...
printf '%s\n' "$ACTIVE_RELEASE" >"$MARKETING_RELEASE"
printf '%s\n' \
