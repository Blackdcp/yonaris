...
The **Settings** section is accessible from the sidebar. It has four sub-pages for managing your Yonaris configuration.
...
Configure which AI models Yonaris queries:
...
- **DeepSeek API** — Requires `DEEPSEEK_API_KEY`; this direct API is separate from the consumer DeepSeek website
