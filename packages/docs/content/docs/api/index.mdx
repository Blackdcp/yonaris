---
title: Overview
description: Complete REST API documentation for the Yonaris administrative API.
---

Yonaris provides a REST API for managing brands, prompts, snapshots, and reports programmatically. All endpoints require Bearer token authentication.
