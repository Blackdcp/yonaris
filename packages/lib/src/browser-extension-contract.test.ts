...
describe("browser extension contract", () => {
	...
	it.each([
		...
		[
			...
			"deepseek-web-20260821-localpc-v6",
		],
		["qwen.consumer_web", "browser_extension.qwen", "https://www.qianwen.com/", "qwen-web-20260821-localpc-v6"],
		["kimi.consumer_web", "browser_extension.kimi", "https://www.kimi.com/", "kimi-web-20260821-localpc-v5"],
		["wenxin.consumer_web", "browser_extension.wenxin", "https://wenxin.baidu.com/", "wenxin-web-20260821-localpc-v5"],
		[
			"yuanbao.consumer_web",
	...
	it("approves Doubao v8 for production and rejects the retired v7 adapter", () => {
		...
		expect(isApprovedBrowserExtensionAdapterVersion("doubao.consumer_web", "doubao-web-20260821-localpc-v12")).toBe(
			true,
		);
	...
	it("requires an explicit exact v8 binding after production activation", () => {
		...
		expect(
			isCurrentBrowserExtensionAdapterVersionBindingSatisfied("doubao.consumer_web", "doubao-web-20260821-localpc-v12"),
		).toBe(true);
	...
	it("requires an explicit exact request as soon as the simulated approval advances to Doubao v8", () => {
		...
		expect(
			isBrowserExtensionAdapterVersionBindingSatisfied({
				...approval,
				requestedAdapterVersion: "doubao-web-20260821-localpc-v12",
			}),
		).toBe(true);
	});
