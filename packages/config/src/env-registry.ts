...
export const ENV_REGISTRY: EnvVarSpec[] = [
	...
	},
	{
		...
		scope: "server",
		requiredBy: "optional",
		description: "Dedicated bearer token accepted only by the internal browser-runner API.",
	},
	{
		name: "BROWSER_RUNNER_ID",
		scope: "server",
		requiredBy: "optional",
		description: "Server-bound principal ID for the Browser Runner bearer credential.",
	},
	{
		name: "BROWSER_RUNNER_MARKET",
		scope: "server",
		requiredBy: "optional",
		description: "Server-bound Browser Runner market; the initial adapter requires CN.",
	},
	{
		name: "BROWSER_RUNNER_LOCALE",
		scope: "server",
		requiredBy: "optional",
		description: "Server-bound Browser Runner locale; the initial adapter requires zh-CN.",
	},
	{
		name: "BROWSER_RUNNER_TIMEZONE",
		scope: "server",
		requiredBy: "optional",
		description: "Server-bound Browser Runner timezone; the initial adapter requires Asia/Shanghai.",
	},
	{
		name: "BROWSER_RUNNER_API_URL",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host base URL for the Yonaris internal Browser Runner API.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_ADAPTER_VERIFIED",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host UAT gate for the current Doubao DOM adapter; must be explicitly true for live execution.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_ANSWER_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host approved selector used to extract the final Doubao answer container.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_COMPLETION_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host approved selector used to verify Doubao response completion.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_DOM_FINGERPRINT",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host identifier for the UAT-approved Doubao DOM selector contract.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_SEARCH_OFF_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Legacy runner-host UAT selector that proves Doubao web search is explicitly off.",
	},
	{
		name: "BROWSER_RUNNER_LIVE_ENABLED",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host-only live execution gate; defaults to disabled and does not schedule work.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_AUTHENTICATED_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host UAT selector proving the dedicated Doubao sampling account is authenticated.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_NEW_CONVERSATION_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host UAT selector for starting a verified blank Doubao conversation.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_USER_MESSAGE_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host UAT selector used to confirm the frozen prompt was submitted exactly once.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_SEARCH_USED_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Optional runner-host UAT selector that positively proves native Doubao web search was used.",
	},
	{
		name: "BROWSER_RUNNER_DOUBAO_SEARCH_NOT_USED_SELECTOR",
		scope: "server",
		requiredBy: "optional",
		description: "Optional runner-host UAT selector that positively proves native Doubao web search was not used.",
	},
	{
		name: "BROWSER_BROKER_SOCKET",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host Unix socket joining the token-holding control process to the isolated browser broker.",
	},
	{
		name: "BROWSER_BROKER_EVIDENCE_DIR",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host bounded evidence handoff directory shared by the browser broker and control process.",
	},
	{
		name: "BROWSER_BROKER_UID",
		scope: "server",
		requiredBy: "optional",
		description: "Expected unprivileged browser-broker UID used to verify evidence ownership.",
	},
	{
		name: "BROWSER_BROKER_RPC_GID",
		scope: "server",
		requiredBy: "optional",
		description: "Expected shared runner RPC GID used to verify the broker socket and evidence boundary.",
	},
	{
		name: "BROWSER_BROKER_STATE_DIR",
		scope: "server",
		requiredBy: "optional",
		description: "Browser-broker-only state root containing the dedicated profile and browser-local markers.",
	},
	{
		name: "BROWSER_BROKER_PEERCRED_HELPER",
		scope: "server",
		requiredBy: "optional",
		description: "Root-owned helper used by the Linux broker to verify Unix-socket peer credentials.",
	},
	{
		name: "BROWSER_BROKER_ALLOWED_CONTROL_UID",
		scope: "server",
		requiredBy: "optional",
		description: "Only control-process UID allowed to call the browser broker Unix socket.",
	},
	{
		name: "BROWSER_NETWORK_POLICY_ENABLED",
		scope: "server",
		requiredBy: "optional",
		description: "Runner-host fail-closed flag proving the root-owned browser egress policy is enabled.",
	},
	{
