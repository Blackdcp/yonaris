...
function OpportunitiesPage() {
	...
	const infoContent =
		"Recommendations based on your visibility and citation metrics, generated by platform operations.";

	let content: React.ReactNode;
	if (brand === undefined || isScopeResolving) {
		content = <LoadingState />;
	} else if (!scopeId) {
		content = <EmptyCard>Add an enabled measurement scope before viewing opportunities.</EmptyCard>;
	} else if (isLoading) {
		content = <LoadingState />;
	} else if (isError) {
		...
		content = <EmptyCard>{opportunityEmptyMessage(data?.reason ?? "insufficient-data")}</EmptyCard>;
	} else {
