...
> = {
	brand: {
		label: "Brand",
		chartColor: "var(--yonaris-data-1, #2563eb)",
		badgeClass: "bg-blue-600/90 text-white yonaris-category-badge yonaris-data-1",
		chartDotClass: "bg-blue-600 yonaris-data-dot yonaris-data-1",
	},
	competitor: {
		label: "Competitor",
		chartColor: "var(--yonaris-data-2, #ef4444)",
		badgeClass: "bg-red-500/90 text-white yonaris-category-badge yonaris-data-2",
		chartDotClass: "bg-red-500 yonaris-data-dot yonaris-data-2",
	},
	editorial: {
		label: "Editorial",
		chartColor: "var(--yonaris-data-3, #a463f2)",
		badgeClass: "bg-purple-500/90 text-white yonaris-category-badge yonaris-data-3",
		chartDotClass: "bg-purple-500 yonaris-data-dot yonaris-data-3",
	},
	reviews: {
		label: "Reviews",
		chartColor: "var(--yonaris-data-4, #efb118)",
		badgeClass: "bg-amber-500/90 text-white yonaris-category-badge yonaris-data-4",
		chartDotClass: "bg-amber-500 yonaris-data-dot yonaris-data-4",
	},
	ecommerce: {
		label: "Ecommerce",
		chartColor: "var(--yonaris-data-5, #36b39a)",
		badgeClass: "bg-teal-500/90 text-white yonaris-category-badge yonaris-data-5",
		chartDotClass: "bg-teal-500 yonaris-data-dot yonaris-data-5",
	},
	social: {
		label: "Social",
		chartColor: "var(--yonaris-data-6, #ff8ab7)",
		badgeClass: "bg-pink-400/90 text-white yonaris-category-badge yonaris-data-6",
		chartDotClass: "bg-pink-400 yonaris-data-dot yonaris-data-6",
	},
	developer: {
		label: "Developer",
		chartColor: "var(--yonaris-data-7, #3ca951)",
		badgeClass: "bg-green-600/90 text-white yonaris-category-badge yonaris-data-7",
		chartDotClass: "bg-green-600 yonaris-data-dot yonaris-data-7",
	},
	pr: {
		label: "PR",
		chartColor: "var(--yonaris-data-8, #f58518)",
		badgeClass: "bg-orange-500/90 text-white yonaris-category-badge yonaris-data-8",
		chartDotClass: "bg-orange-500 yonaris-data-dot yonaris-data-8",
	},
	reference: {
		label: "Reference",
		chartColor: "var(--yonaris-data-9, #b279a2)",
		badgeClass: "bg-fuchsia-500/90 text-white yonaris-category-badge yonaris-data-9",
		chartDotClass: "bg-fuchsia-500 yonaris-data-dot yonaris-data-9",
	},
	institutional: {
		label: "Institutional",
		chartColor: "var(--yonaris-data-10, #79a8e8)",
		badgeClass: "bg-sky-500/90 text-white yonaris-category-badge yonaris-data-10",
		chartDotClass: "bg-sky-500 yonaris-data-dot yonaris-data-10",
	},
	other: {
		label: "Other",
		chartColor: "var(--yonaris-data-11, #9498a0)",
		badgeClass: "bg-slate-400/90 text-white yonaris-category-badge yonaris-data-11",
		chartDotClass: "bg-slate-400 yonaris-data-dot yonaris-data-11",
	},
};
...
export const PAGE_TYPE_CONFIG: Record<CitationPageType, { label: string; chartColor: string }> = {
	homepage: { label: "Homepage", chartColor: "var(--yonaris-data-1, #79a8e8)" },
	article: { label: "Article", chartColor: "var(--yonaris-data-2, #2563eb)" },
	listicle: { label: "Listicle", chartColor: "var(--yonaris-data-3, #36b39a)" },
	howto: { label: "Guide", chartColor: "var(--yonaris-data-4, #a463f2)" },
	comparison: { label: "Comparison", chartColor: "var(--yonaris-data-5, #f58518)" },
	review: { label: "Review", chartColor: "var(--yonaris-data-6, #ff8ab7)" },
	forum: { label: "Forum", chartColor: "var(--yonaris-data-7, #11a8cd)" },
	video: { label: "Video", chartColor: "var(--yonaris-data-8, #ef4444)" },
	doc: { label: "Docs", chartColor: "var(--yonaris-data-9, #b279a2)" },
	product: { label: "Storefront", chartColor: "var(--yonaris-data-10, #3ca951)" },
	info: { label: "Info", chartColor: "var(--yonaris-data-11, #efb118)" },
	search: { label: "Search", chartColor: "var(--yonaris-data-12, #b6992d)" },
	shopping: { label: "Shopping", chartColor: "var(--yonaris-data-13, #9c6b4e)" },
	other: { label: "Other", chartColor: "var(--yonaris-data-14, #9498a0)" },
};
