...
export const SAMPLING_BATCH_REQUEST_ID = "stepfun-cn-doubao-6x-20260816-v6";
export const SAMPLING_BATCH_IDEMPOTENCY_KEY = "sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-16-v6";
export const SAMPLING_BATCH_NAME = "StepFun CN Doubao formal sampling 2026-08-16 - 6x - v6";
