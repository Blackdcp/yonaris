...
export const SAMPLING_BATCH_REQUEST_ID = "stepfun-cn-doubao-6x-20260813";
export const SAMPLING_BATCH_IDEMPOTENCY_KEY = "sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-13";
export const SAMPLING_BATCH_NAME = "StepFun CN Doubao sampling 2026-08-13 - 6x";
export const SAMPLING_BATCH_WINDOW_STARTS_AT = "2026-08-13T00:00:00+08:00";
