...
export const SAMPLING_BATCH_REQUEST_ID = "stepfun-cn-doubao-6x-20260816-v4";
export const SAMPLING_BATCH_IDEMPOTENCY_KEY = "sampling:stepfun:cn-zh-scored:doubao:6x:2026-08-16-v4";
