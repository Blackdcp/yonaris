...
export const GOVERNED_HTML_ROUTES = [
	{ path: "/resources", copy: [] },
	{ path: "/open-source", copy: ["Open-source infrastructure"] },
	{ path: "/privacy", copy: [] },
	{ path: "/blog", copy: [], noindex: true },
	{ path: "/blog/ai-brand-sentiment", copy: [], noindex: true },
	{ path: "/glossary", copy: [], noindex: true },
	{ path: "/glossary/ai-visibility", copy: [], noindex: true },
	{ path: "/docs", copy: ["Open-source Documentation"] },
	{ path: "/docs/getting-started", copy: ["Open-source Documentation"] },
	{ path: "/status", copy: [] },
	{ path: "/brand", copy: [] },
	{ path: "/changelog", copy: [] },
	{ path: "/roadmap", copy: [], noindex: true },
	{ path: "/ai-search", copy: ["Legacy research archive"], noindex: true },
	{ path: "/ai-search/chatgpt", copy: ["Legacy research archive"], noindex: true },
	{ path: "/aeo-for", copy: ["Legacy research archive"], noindex: true },
	{ path: "/aeo-for/agencies", copy: ["Legacy research archive"], noindex: true },
	{ path: "/ai-visibility-tools", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/elmo-vs-profound", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/alternatives", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/alternatives/profound", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/category", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/category/tracking", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/category/open-source", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{ path: "/ai-visibility-tools/compare", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{
		path: "/ai-visibility-tools/compare/profound-vs-peec-ai",
		copy: ["Upstream Elmo comparison archive"],
		noindex: true,
	},
	{ path: "/ai-visibility-tools/features", copy: ["Upstream Elmo comparison archive"], noindex: true },
	{
		path: "/ai-visibility-tools/features/multi-llm-tracking",
		copy: ["Upstream Elmo comparison archive"],
		noindex: true,
	},
];
...
const MACHINE_ROUTES = [
	...
	{ path: "/blog/rss.xml", contentType: "xml", copy: ["<rss"] },
	{ path: "/api/openapi.json", contentType: "application/json", copy: [] },
	{ path: "/api/search?q=yonaris", contentType: "application/json", copy: [] },
	{ path: "/repo-activity.svg", contentType: "image/svg+xml", copy: [] },
