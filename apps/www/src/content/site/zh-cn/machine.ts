...
export const ZH_MACHINE_FACTS: Readonly<Record<ZhMachinePageKey, ZhMachineFacts>> = {
		...
		claims: [
			{
				...
				text: "客户可在工作空间查看配置化回答记录及其证据状态。",
			},
			{
				id: "human-agent-parity",
				status: "verified-evidence",
				text: "中国区域人类页面和 Agent 页面公开同一套范围、能力、证据与边界事实。",
			},
		],
	...
	product: {
		...
		claims: [
			{
				id: "connected-workbench",
				status: "current-software",
				text: "同一工作流保留问题、回答、证据、判断和下一次测试之间的关系。",
			},
	...
	approach: {
		...
		claims: [
			{
				id: "five-stage-delivery",
				status: "managed-delivery",
				text: "范围在观察前确认，行动由客户批准，复测保持原有比较规则。",
			},
		],
	...
	research: {
		...
		claims: [
			{
				id: "visible-denominator",
				status: "verified-evidence",
				text: "任何比例与它的有效分母、市场范围和观察条件一起定义。",
			},
	...
	geo: {
		...
		claims: [
			{
				id: "configured-market-context",
				status: "managed-delivery",
				text: "中国市场与全球目标市场分别配置语言、购买问题、回答界面和竞争范围。",
			},
		],
	...
	company: {
		...
		claims: [
			{
				id: "china-to-global-service",
				status: "managed-delivery",
				text: "中国企业的全球市场观察按目标市场重新确认语言、问题、界面、竞争范围和周期。",
			},
		],
	...
	diagnostic: {
		...
		claims: [
			{
				id: "china-contact-contract",
				status: "verified-evidence",
				text: "中国区域公开表单的三个可见字段是姓名、电话和公司。",
			},
		],
	...
	privacy: {
		...
		claims: [
			{
				id: "provider-confirmed-success",
				status: "verified-evidence",
				text: "页面只在邮件服务确认接收后显示提交成功。",
			},
		],
