...
export const SITE_MANIFEST = [
	...
	},
	{
		key: "aiVisibility",
		routeClass: "legacy",
		canonicals: { en: "/ai-visibility-tools" },
		patterns: ["/ai-visibility-tools/*"],
		navigation: [],
		indexPolicy: "noindex,follow",
		sitemap: false,
	},
	...
	},
	{
		key: "repoActivity",
		routeClass: "machine",
		canonicals: { en: "/repo-activity.svg" },
		navigation: [],
		indexPolicy: "noindex,follow",
		sitemap: false,
	},
