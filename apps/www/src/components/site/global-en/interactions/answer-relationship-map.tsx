...
const nodes = [
	{
		...
		label: "Discovery",
		question: "Where does the brand enter the answer?",
		artifact: "Presence record",
	},
	{
		id: "description" as const,
		label: "Description",
		question: "How is the brand and category explained?",
		artifact: "Claim annotation",
	},
	{
		id: "comparison" as const,
		label: "Comparison",
		question: "Which criteria frame the choice?",
		artifact: "Cohort comparison",
	},
	{
		id: "sources" as const,
		label: "Sources",
		question: "Which available evidence accompanies the answer?",
		artifact: "Source state",
	},
	{
		id: "measurement" as const,
		label: "Measure",
		question: "What changed under the same observation rules?",
		artifact: "Repeat record",
	},
] as const;
