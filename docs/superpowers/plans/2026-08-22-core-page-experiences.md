...
- Category: `AI market evidence`; vision: `Market evidence, built for teams and systems.`
...
expect(JSON.stringify(content)).not.toContain("Product Evidence Graph");
