---
name: add-competitor
description: Add a new competitor to the AI answer presence Tool Directory — researches the tool, generates data, takes a screenshot, and inserts into the codebase
argument-hint: <url>
---

Add a new competitor to the AI answer presence tool directory at `apps/www/src/lib/competitors/data.ts`.
...
- `visibilityScore` — provides an aggregate AI answer presence score
...
1. **Is AI answer presence / AEO the tool's PRIMARY product?** Pure AEO trackers rank above SEO suites or content platforms that bolted on AEO features.
...
- The URL where the comparison page will be: `/answer-presence-tools/yonaris-vs-<slug>`
